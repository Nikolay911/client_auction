...
import com.example.auction1_client.config.LoginFileConfigProperties;
...
public class GeneralService {
    ...
    public User findByUsername(String username) {
        ...
        if(userLog.size()==1){
            User findUser = new User(userLog.get(0).getLogin(), userLog.get(0).getPassword(), userLog.get(0).getRole(), userLog.get(0).getCustomerId());
            return findUser;
        }
        else{
            User badUser = null;
